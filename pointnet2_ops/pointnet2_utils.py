...
class GatherOperation(Function):
    ...
    def forward(ctx, features, idx):
        ...
        ctx.save_for_backward(idx.contiguous(), features)

        return _ext.gather_points(features, idx.contiguous())
    ...
    def backward(ctx, grad_out):
        ...
        grad_features = _ext.gather_points_grad(
            grad_out.contiguous(), idx.contiguous(), N
        )
...
class GroupingOperation(Function):
    ...
    def forward(ctx, features, idx):
        ...
        return _ext.group_points(features, idx.contiguous())
    ...
    def backward(ctx, grad_out):
        ...
        grad_features = _ext.group_points_grad(
            grad_out.contiguous(), idx.contiguous(), N
        )
